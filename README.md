# Дипломный проект
## Тема дипломного проекта — премиальный кинотеатр с красивым дизайном, Entity Framework, отправкой сообщений на e-mail и идеально написанной по гостам и одобренной всеми преподами пояснительной запиской
##
## Лист заданий:
